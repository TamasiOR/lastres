...
import { UserPlus, MoreVertical, Star, UserCheck, Mail, Settings } from 'lucide-react';
          ...
          <div className="flex items-center gap-1">
            <Button
              ...
              onClick={() => toast({
                ...
                description: "Opening member approval panel..."
              })}
            ...
            <Button
              ...
              onClick={() => toast({
                ...
                description: "Opening member management settings..."
              })}
              className="hover:bg-primary/20 transition-all duration-200"
              title="Member settings"
            >
        ...
        <div className="space-y-2">
          ...
          {showMembers && (
            <ChannelMembers 
              ...
              onInviteMembers={() => setShowInviteManager(true)}
              onManageMembers={() => setShowMemberApproval(true)}
            />
          )}
        </div>
      </div>
